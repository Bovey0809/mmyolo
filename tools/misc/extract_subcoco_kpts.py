...
def _process_data(args,
    ...
    int_ann_file_name = f'annotations/person_keypoints_{in_dataset_type}{year}.json'
    out_ann_file_name = f'annotations/person_keypoints_{out_dataset_type}{year}.json'
